        ...
        return this.state.orders.map((order) => {
          ...
          return (
            <tr key={id} className={styles.cartItem}>
              <td className={styles.productRemove} onClick={this.removeOrder(id)}>X</td>
              <td className={styles.productThumbnail}>
                <img src={image} alt='Thumbnail product' />
              </td>
            ...
            <div className={styles.wrapperTotalPrice}>
              <div className={styles.totalSection}>
                ...
                <div className={styles.prepareToCheckout}>
                      <NavLink to='/payments'><button type='submit' className={styles.checkout}>Przejdz do kasy</button></NavLink>
                </div>
              </div>
            </div>
          </section>
